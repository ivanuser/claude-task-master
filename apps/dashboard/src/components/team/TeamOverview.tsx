      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-2xl font-semibold text-gray-900">{team.projectCount}</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6">
          ...
          <div className="space-y-3">
            ...
            <div>
              <label className="text-sm font-medium text-gray-700">Team URL</label>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <button className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-500">Add new team members</p>
            </div>
          </button>
          ...
          <button className="flex items-center gap-3 p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
            ...
            <div className="text-left">
              ...
              <p className="text-xs text-gray-500">Configure team</p>
            </div>
          </button>
        </div>
      </div>
